            ...
            if (mainMemberTypes != null) {
                for (int i = 0; i < mainMemberTypes.Length; ++i) {
                    ...
                    if (unionMember != null) {
                        ...
                        throw new XmlSchemaException(Res.Sch_UndeclaredSimpleType, mainMemberTypes[i].ToString(), simpleType);   
                    }
                }
            }
                    ...
                    if (attributeGroupResolved != null) {
                        ...
                        foreach (XmlSchemaAttribute attributeValue in attributeGroupResolved.AttributeUses.Values) {
                            if (attributeGroup.AttributeUses[attributeValue.QualifiedName] == null) {
                                ...
                                SendValidationEvent(Res.Sch_DupAttributeUse, attributeValue.QualifiedName.ToString(), attributeValue);
                            }
                        }
                        ...
                        foreach (XmlSchemaAttribute attributeValue in attributeGroup.AttributeUses.Values) {
                          if (attributeValue.Use != XmlSchemaUse.Prohibited || 
                            ...
                            if (derivedType.AttributeUses[attributeValue.QualifiedName] == null) {
                                ...
                                SendValidationEvent(Res.Sch_DupAttributeUse, attributeValue.QualifiedName.ToString(), attributeGroupRef);
                            }
                          }
                          else {
                            SendValidationEvent(Res.Sch_AttributeIgnored, attributeValue.QualifiedName.ToString(), attributeValue, XmlSeverityType.Warning);
                          }
