...
namespace System.Linq.Parallel
{
    ...
    {
        private Shared<TInputOutput[]> m_results; // The destination array cell into which data is placed.
        private SortHelper<TInputOutput> m_sortHelper; // A helper that performs the sorting.
